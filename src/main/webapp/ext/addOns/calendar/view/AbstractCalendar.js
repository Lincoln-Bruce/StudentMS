...
Ext.define('Ext.calendar.view.AbstractCalendar', {
    ...
    initComponent: function() {
    	var curDate = Ext.Date.parse(xjs.app.common.common.Util.getBussinessDate(), "Y-m-d");
        this.setStartDate(this.startDate || curDate);
     ...
     */
    isToday: function() {
        var today = Ext.Date.clearTime(new Date(xjs.app.common.common.Util.getBussinessDate())).getTime();
    ...
    moveToday: function(noRefresh) {
        return this.moveTo(new Date(xjs.app.common.common.Util.getBussinessDate()), noRefresh);
    },
