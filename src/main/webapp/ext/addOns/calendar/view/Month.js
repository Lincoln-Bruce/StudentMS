...
Ext.define('Ext.calendar.view.Month', {
    ...
    initClock: function() {
        if (Ext.fly(this.id + '-clock') !== null) {
            this.prevClockDay = new Date(xjs.app.common.common.Util.getBussinessDate()).getDay();
            if (this.clockTask) {
            ...
            this.clockTask = Ext.TaskManager.start({
                run: function() {
                    ...
                    t = new Date(xjs.app.common.common.Util.getBussinessDate());
    ...
    getTemplateEventData: function(evt) {
        ...
        return Ext.applyIf({
            ...
            Title: evt[M.IsWork.name] == true ? '<font style=\'color : red;\'>工作日<font>' : ''
        },
        evt);
    },
